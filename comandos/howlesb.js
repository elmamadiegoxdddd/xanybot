...
module.exports = {
  name: "howlesb",//Nombre del comando
  alias: ["lesb"],//Alias del comando (Por si quieres activar el comando de 2 maneras)
  execute (client, message, args) {
   ...
   let suerte = [Math.floor(Math.random() * 100)]
    ...
    .setTitle("Que tan lesbiana eres?")
    .addField("Eres" ,`\n**${random}%** **lesbiana :gay_pride_flag:**`)
    .setTimestamp()
    .setColor(0x00ffeb)
