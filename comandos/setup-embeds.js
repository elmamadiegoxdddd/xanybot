...
module.exports = {
  ...
  execute: async (client, message, args, prefix) => {
    ...
    if(channel) {
        ...
        if(msg){
          ...
          const msg1 = await message.guild.channels.cache.get(objeto.canal).send({
            embeds: [new Discord.MessageEmbed()
             ...
             return message.reply({ content: `<:_:1022197353983254528> **Embed configurado, en: <#${objeto.canal}>**`, ephemeral: true })
            }).catch(() => {
              return message.reply({
                embeds: [new Discord.MessageEmbed()
                    .setTitle("<:_:1022197356554362931> **El tiempo ha expirado!**")
                    ],
                 })
              })
           }
      ...
      return message.reply({
        embeds: [new Discord.MessageEmbed()
            .setTitle("<:_:1022248604200607814> **No se ha encontrado el canal que has especificado!**")
            ],
         })
  }
